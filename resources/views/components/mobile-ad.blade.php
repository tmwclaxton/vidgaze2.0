<div class="p-4 w-full text-center bg-white rounded-lg border shadow-md sm:p-8 dark:bg-gray-800 dark:border-gray-700">
    <h5 class="mb-2 text-3xl font-bold text-gray-900 dark:text-white">Download VidGaze Mobile</h5>
    <p class="mb-5 text-base text-gray-500 sm:text-lg dark:text-gray-400">Watch all your favourite creators with
        VidGaze on iOS &amp; Android.  Download the app today.</p>
