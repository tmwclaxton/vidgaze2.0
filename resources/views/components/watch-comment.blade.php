...
@endphp
@while($start != $level)
    <hr style="width:1px; margin-left:24px;"
    class="m-0 p-0 mt-2 bg-blend-normal divider divider-horizontal  h-full">
    @php $start++;  @endphp
@endwhile
    ...
    <div  class=" flex w-full">
        ...
        <div class="m-2 mr-2 ">
            <div class="w-9">
                ...
                <img class=" z-1 relative hover:cursor-pointer inline object-cover w-9 h-9  rounded-full"
                src="{{$img}}"
                alt="Profile image"/>
            ...
            position: relative;
            margin-top: -20px;
            " class="m-0 p-0 z-0 ml-4 divider divider-horizontal  h-full">
        ...
        <div class="pl-1 pt-1 ">
            ...
            <span class="ml-auto flex justify-start font-semibold pt-3 hover:cursor-pointer">

                @if ($button != 1)
                    <svg xmlns="http://www.w3.org/2000/svg"
                    fill="currentColor"
                    class="bi bi-hand-thumbs-up h-4 mt-1"
                    viewBox="0 0 16 16">
                ...
                <p class=" pl-1 pr-2">{{$likes}}</p>
                @if ($button != 2)
                    <svg xmlns="http://www.w3.org/2000/svg"
                    fill="currentColor"
                    class="bi bi-hand-thumbs-down h-4 mt-1"
                    viewBox="0 0 16 16">
                ...
                @else
                    <svg xmlns="http://www.w3.org/2000/svg"
                     fill="currentColor"
                    class="bi bi-hand-thumbs-down-fill h-4 mt-1"
                     viewBox="0 0 16 16">
            ...
            <span class=" hover:cursor-pointer text-blue-800 flex justify-start font-semibold pt-2">
                <svg enable-background="new 0 0 64 64"
                viewBox="0 0 64 64"
                fill="blue"
                class="h-4 pt-1 mt-1 mr-2"
